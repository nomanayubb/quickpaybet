...
from .views import (
    ...
    admin_casino_game_blur_view,
    admin_casino_game_live_blur_view,
...
urlpatterns = [
    ...
    path('panel/casino/games/<int:game_id>/blur/', admin_casino_game_blur_view, name='admin_casino_game_blur'),
    path('panel/casino/games/<int:game_id>/live-blur/', admin_casino_game_live_blur_view, name='admin_casino_game_live_blur'),
